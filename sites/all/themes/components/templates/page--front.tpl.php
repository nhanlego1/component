...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header"><a class="navbar-brand navbar-link" href="/" style="/*margin-left:56px;*/padding-left:62px;">Splash Component<img class="img-responsive" src="<?php print base_path().drupal_get_path('theme','components') ?>/splash/assets/img/logo.png" style="width:52px;position:absolute;top:2px;left:5px;"></a>
...
<div class="jumbotron hero">
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-md-push-7 phone-preview" style="height:497px;">
        <div class="iphone-mockup"><img src="<?php print base_path().drupal_get_path('theme','components') ?>/splash/assets/img/sc-grapesjs-responsive-2.jpg" class="device" style="height:auto;width:454px;margin-right:29px;"></div>
      </div>
      <div class="col-md-6 col-md-pull-3 get-it">
        <h1>Design website without coding</h1>
        <p>Next generation tool for building templates without coding </p>
        <p><a class="btn btn-primary btn-lg" role="button" href="/components/create"><i class="fa fa-file"></i> Design new template</a><a class="btn btn-success btn-lg" role="button" href="#"><i class="fa fa-drupal"></i> Published to drupal</a></p>
      </div>
    </div>
  </div>
</div>
